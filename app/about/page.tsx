    ...
    <PageShell>
      ...
      <section className="hairline-b">
        <HeroMedia height="lg" gradient="bottom" grain>
          <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy-950)] via-[var(--color-navy-900)]/60 to-[var(--color-navy-900)]/25 pointer-events-none z-[1]" />
          <div className="absolute inset-0">
            <Video
              ...
              poster="/images/misc/collaborative-approach.jpg"
              ratio="auto"
              autoPlay
              loop
              muted
      ...
      <Section tone="paper" padding="sm" hairlineBottom>
        <Container>
          <AnimatedStatBlock stats={aboutStats} columns={4} size="xl" />
        </Container>
      </Section>
      ...
      {/* CTA: default tone to avoid double navy with footer */}
        ...
        <Container>
          <FadeIn>
            <CTABlock
              ...
              title="Meet the team behind the platform."
              description="Questions about our company, leadership, or culture? We're always happy to talk."
